...
const FeaturePopular = () => {
  ...
  return (
    ...
    <h2>{item.popularName}</h2>
    <div className='trending-row'>
      <div className='trending-col'>
        <div className='trending-card'>
          <div className='trending-img'>
            <img src={item.popularImgUrl}></img>
          </div>
        </div>
      </div>
      <div className='trending-col'>
        <div className='trending-card'>
          <h2>{item.populatAmount} - 15.00 Lahk</h2>
    ...
    <div className='trending-rates'>
      <h3>{item.popularName}</h3>
      <p>{item.popularName} price for the base model starts at {item.populatAmount} Lakh and the top model price goes upto Rs. 15.50 Lakh (Avg. ex-showroom). Nexon price for 68 variants is listed below.</p>
      ...
      <table>
        <h3 className='heading'>{item.popularName} Car Specification</h3>
        <tr>
          <td>🏧 Price</td>
          <th>{item.populatAmount}</th>
        </tr>
        <tr>
          <td>🧳 Mileage</td>
          <th>{item.mileage}</th>
    ...
    <div className='trend'>
      <h3 className='heading'>How is the {item.popularName} Car</h3>
        ...
        <div className='trending-col'>
          <div className='trending-card'>
            ...
            <ul className='trending-list'>
              <li>The {item.popularName} styling is extensively tweaked to make it look attractive and sharp.</li>
        ...
        <div className='trending-col'>
          <div className='trending-card'>
            ...
            <ul className='trending-list'>
              ...
              <li>The {item.popularName} diesel engine is not as refined as the segment competitors.</li>
    ...
    <table className='mileage'>
      <h3 className='heading'>{item.popularName} Mileage</h3>
      <tr>
        <th>Powertrain</th>
        <th>ARAI Mileage</th>
    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
      <h3 className='heading'>FAQs About {item.popularName}</h3>
      <div class="accordion-item">
        ...
        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body"><h3>Q: What is the top speed of {item.popularName}?</h3>
            <p>{item.popularName} has a top speed of 270 Kmph.</p></div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body"><h3>Q: What is the seating capacity in {item.popularName}?</h3><p>{item.popularName} has a seating capacity of {item.seat} people.</p><h3>Q: What are the dimensions of Porsche Panamera?</h3><p>The dimensions of {item.popularName} include its length of 5049 mm, width of 1937 mm and height of 1423 mm. The wheelbase of the {item.popularName} is 2950 mm.</p></div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body"><h3>Q: Does {item.popularName} get ABS?</h3><p>Yes, all variants of {item.trendName} have ABS. ABS is a great accident prevention technology, allowing drivers to steer while braking hard.</p></div>
        </div>
      </div>
